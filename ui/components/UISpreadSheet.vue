<template>
    ...
    <div className="ui-spreadsheet-wrapper" :style="{ overflow: 'auto' }">
        <!-- タイトル表示 -->
...
export default {
    ...
    setup(props) {
        console.info('UISpreadSheet setup with:', props)
    ...
    methods: {
        ...
        */
        ...
        /*
            ...
            See the ui-spreadsheet.js file for how to subscribe to these.
        */
        sendDate() {
            this.$socket.emit('spreadsheet-event', this.id, {
                payload: 'SpreadSheet Event',
            })
        }
    }
}
